...
def chatbot_response(user_input):
    # Clean the input: lowercase and strip whitespace
    user_input = user_input.lower().strip()

    # Organized dictionary: Regex Pattern -> Response
    # Note: We use \b to ensure '1' doesn't match '10'
    responses = {
...
while True:
    ...
    if re.search(r"\b(exit|bye|19)\b", user_message.lower()):
